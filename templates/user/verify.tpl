...
<form action="?cmd=mfa&action={$action}{if $smarty.get.redirect}&redirect={$smarty.get.redirect}{/if}" method="POST">
    ...
    <div class="wbox">
        <div class="wbox_header">
            {if $confirm}{$lang[$confirm.name]|default:$confirm.name}{else}{$lang.login}{/if}
        </div>
        <div class="wbox_content">
            ...
            <div {if $auto_send_code == 0} style="display: none" {/if}id="2faform">
                <div class="form-group" >
                    ...
                    <input name="code" class="styled form-control" type="number" id="code" autofocus autocomplete="one-time-code"/>
                </div>
